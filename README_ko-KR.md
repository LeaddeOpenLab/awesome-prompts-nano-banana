...
### 핑크빛 스튜디오 배경 앞에서 단추를 풀린 흰색 크롭 셔츠를 입은 젊은 여성의 인물 사진.

작성자：[@NoahNeku](https://x.com/NoahNeku) · [원본 게시물](https://x.com/NoahNeku/status/2102417435521634722)

인물 사진 / 셀카 · 캐릭터 · 배포 완료

**요약:** 핑크빛 스튜디오 배경 앞에서 단추를 풀린 흰색 크롭 셔츠를 입은 젊은 여성의 인물 사진.
...
```text
{
  "prompt": "웨이브진 긴 흑발과 담갈색 눈동자를 지니고 무표정한 얼굴로 카메라를 정면으로 응시하는 젊은 여성의 4K HD 인물 사진. 깊게 파인 네크라인과 단추를 채우지 않은 흰색 반소매 칼라 크롭 셔츠를 입고 매끄러운 핑크빛 스튜디오 배경 앞에서 포즈를 취하고 있다.",
  "subject": {
    "gender": "여성",
    "hair": {
      "color": "다크 브라운",
      "style": "가운데 가르마를 탄 긴 머리, 양 어깨 위로 자연스럽게 늘어뜨려진 루즈한 웨이브"
    },
    "facial_features": {
      "eyes": "담갈색 / 밝은 갈색, 렌즈를 정면으로 바라봄",
      "eyebrows": "자연스럽고 또렷함, 짙은 색",
      "skin": "밝은 피부톤, 자연스러운 피부 결, 은은한 이슬 같은 하이라이트",
      "expression": "무표정, 편안함, 차분함"
    },
    "attire": {
      "top": "흰색 반소매 칼라 크롭 셔츠",
      "style": "깊게 파인 네크라인, 단추가 채워지지 않은 앞면"
    }
  },
  "setting": {
    "background": "단색 파스텔 핑크 심리스 스튜디오 배경",
    "details": "오른쪽 상단 모서리에 스튜디오 장비의 가장자리가 보임"
  },
  "technical_details": {
    "shot_type": "미디엄 클로즈업 인물 사진",
    "framing": "중앙 정렬, 허리 위 상반신 구도",
    "lighting": "부드럽게 확산된 스튜디오 조명, 은은한 필 라이트",
    "camera_settings": {
      "resolution": "4K UHD",
      "lens_type": "85mm 인물 렌즈",
      "depth_of_field": "얕은 심도, 부드러운 배경 롤오프와 함께 피사체에 선명한 초점",
      "color_grade": "자연스러운 웜톤, 깔끔한 파스텔 대비"
    }
  }
}
```
