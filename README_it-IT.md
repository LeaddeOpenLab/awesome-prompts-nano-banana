# Nano Banana · Raccolta di prompt · Leadde.ai
...
**22** Prompt · Ultima aggiunta: **2026-09-14**

<a name="catalog"></a>

## Sfoglia per categoria

[Fotografia](#category-photography) · [Fermo immagine cinematografico / Still fotografico](#category-cinematic-film-still) · [Rendering 3D](#category-3d-render) · [Retro / Vintage](#category-retro-vintage) · [Cyberpunk / Sci-Fi](#category-cyberpunk-sci-fi) · [Altro](#category-other)
...
Fotografia · Ritratto / Selfie · Personaggio · Architettura / Interni · Abstract / Contesto · Pubblicato
...
<img src="images/2098763429636907474-2.jpg" alt="Immagine 2" width="480" />

<img src="images/2098763429636907474-3.jpg" alt="Immagine 3" width="480" />

<img src="images/2098763429636907474-4.jpg" alt="Immagine 4" width="480" />

<img src="images/2098763429636907474-5.jpg" alt="Immagine 5" width="480" />

<img src="images/2098763429636907474-6.jpg" alt="Immagine 6" width="480" />
...
<img src="images/2097564694974541836-2.jpg" alt="Immagine 2" width="480" />

<img src="images/2097564694974541836-3.jpg" alt="Immagine 3" width="480" />

<img src="images/2097564694974541836-4.jpg" alt="Immagine 4" width="480" />
...
<img src="images/2097549831489405424-2.jpg" alt="Immagine 2" width="480" />

<img src="images/2097549831489405424-3.jpg" alt="Immagine 3" width="480" />

<img src="images/2097549831489405424-4.jpg" alt="Immagine 4" width="480" />
...
<img src="images/2097524090735075539-2.jpg" alt="Immagine 2" width="480" />
...
### Un prompt in stile pseudocodice per una griglia 2x2 di diorami di santuari in marmo 3D dedicati a pensatori famosi.

Autore：[@Gdgtify](https://x.com/Gdgtify) · [Post originale](https://x.com/Gdgtify/status/2097629839209758892)

Rendering 3D · Pubblicato

**Riepilogo:** Un prompt in stile pseudocodice per una griglia 2x2 di diorami di santuari in marmo 3D dedicati a pensatori famosi.
...
```text
griglia 2x2, 16:9, applica questo a 4 celebri pensatori, autori o inventori: class Mind_As_Shrine_Diorama:
    def __init__(self, thinker="[NOME_DEL_PENSATORE]"):
        self.canvas = "Vignetta scultorea monumentale 3D singola e autonoma su sfondo da studio bianco puro."
        self.material_palette = "Marmo bianco di Carrara lucidato, ottone spazzolato, lenti di vetro e viste cosmiche luminose."

    def construct_face_and_hair_arch(self):
        # Il nucleo del gioco visivo: la capigliatura diventa l'edificio
        hair_motif = infer_iconic_hair_or_silhouette(self.thinker)
        name_arch = f"Lettere monumentali in marmo dorato 3D che compongono '{self.thinker.upper()}', integrate direttamente in un arco ornato di nuvole vorticose barocche che rappresenta l'esagerato {hair_motif}."
        face_core = f"Centro: Un volto realistico scolpito nel marmo di {self.thinker} che emerge dal pavimento di pietra, con occhiali circolari le cui lenti di vetro mostrano la sua formula/simbolo principale."
        return [name_arch, face_core]

    def construct_internal_brain_chambers(self):
        # AUTO-DEDUZIONE DELL'IA: Suddividi la loro eredità intellettuale in due camere distinte
        theory_left = infer_primary_breakthrough(self.thinker) # ad es. Relatività speciale, porte logiche, selezione naturale
        theory_right = infer_secondary_breakthrough(self.thinker) # ad es. Relatività generale, stato quantico, ottica
        
        chamber_left = f"Camera superiore sinistra: Lavagne in miniatura con equazioni autentiche di {theory_left}, modelli meccanici di esperimenti mentali (ad es. treni, orologi, ingranaggi) e una biblioteca di minuscoli libri."
        chamber_right = f"Camera superiore destra: Vista cosmica dello spazio profondo che illustra {theory_right}, completa di strumenti ottici, modelli atomici e un pozzo/imbuto gravitazionale volumetrico."
        return [chamber_left, chamber_right]

    def construct_base(self):
        quote = infer_signature_quote(self.thinker)
        return f"Un plinto circolare a gradini in marmo con rivetti in ottone, un manoscritto aperto con testo scritto a mano e una targa curva in ottone incisa con: '{quote}'."
...
### Ritratto da studio di alta moda di un'elegante donna in abito nero su una sedia scultorea nera.

Autore：[@Elvorya](https://x.com/Elvorya) · [Post originale](https://x.com/Elvorya/status/2097548956251168916)

Ritratto / Selfie · Personaggio · Articolo di moda · Pubblicato

**Riepilogo:** Ritratto da studio di alta moda di un'elegante donna in abito nero su una sedia scultorea nera.
...
```text
Ritratto da studio di alta moda ultra-realistico di una donna elegante seduta con grazia contro uno sfondo grigio antracite scuro. Indossa un sofisticato abito in raso nero monospalla con sottili decorazioni scintillanti. Capelli castano scuro lisci e lucenti, pettinati all'indietro con cura dietro le spalle. Trucco glamour raffinato, sopracciglia leggermente definite, ombretto marrone sfumato, eyeliner marcato, ciglia lunghe, blush caldo, pelle naturale luminosa e labbra nude rosate lucide. Indossa eleganti orecchini pendenti geometrici in argento, molteplici anelli delicati in argento, un bracciale sottile e un piccolo ear cuff.

Posa: seduta su una sedia scultorea nera lucida, un braccio appoggiato con naturalezza sulla sedia e l'altra mano sollevata delicatamente sotto il mento, con dita rilassate ed eleganti. Unghie lunghe e curate con smalto nero lucido. Sguardo diretto verso la fotocamera, calmo e sicuro di sé, espressione sofisticata.

Fotografia di bellezza di lusso professionale, luce principale soffusa e diffusa, sottile luce d'accento sui contorni, ombre profonde, contrasto elevato, texture della pelle realistica, lineamenti del viso dettagliati, finitura editoriale impeccabile, atmosfera cinematografica, messa a fuoco nitida, obiettivo per ritratti da 85 mm, profondità di campo ridotta, estetica da rivista di moda di alta gamma, fotorealistica, 4K, composizione verticale.
```
