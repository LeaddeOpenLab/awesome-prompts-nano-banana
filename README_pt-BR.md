...
**30** Prompts · Última adição: **2026-09-23**

<a name="catalog"></a>

## Explorar por categoria

[Fotografia](#category-photography) · [Cinematográfico / Imagem de Filme](#category-cinematic-film-still) · [Renderização 3D](#category-3d-render) · [Retrô / Vintage](#category-retro-vintage) · [Cyberpunk / Ficção Científica](#category-cyberpunk-sci-fi) · [Outros](#category-other)
...
### Foto editorial de um homem com um laptop na cabine de um carro de luxo com couro conhaque.
...
**Resumo:** Foto editorial de um homem com um laptop na cabine de um carro de luxo com couro conhaque.
...
```text
Um belo jovem adulto do sexo masculino com cabelos escuros, cacheados e despenteados está sentado ao centro em uma postura relaxada, olhando para baixo com uma expressão séria e espontânea, boca fechada e neutra, e sobrancelhas relaxadas. Ele veste uma camisa polo azul-marinho escuro com detalhes em um colarinho com acabamento em branco brilhante e calças brancas impecáveis. Um relógio prateado de elos metálicos adorna seu pulso esquerdo, que está ligeiramente elevado enquanto sua mão esquerda repousa casualmente no lado esquerdo da base preta do teclado de um laptop prateado, enquanto sua mão direita relaxada tem os dedos indicador e médio tocando suavemente o trackpad, transmitindo uma prontidão orgânica e casual para digitar. Ele está posicionado na profundidade espacial rasa da cabine traseira de um automóvel executivo de luxo, sentado contra um plano médio impecável de couro marrom-conhaque com padrões perfurados refinados e costuras detalhadas e precisas. Apoios de cabeça dianteiros de couro marrom-conhaque liso no primeiro plano flanqueiam simetricamente e emolduram sua silhueta, enquanto uma janela do carro com película escura à esquerda reflete discretas luzes da rua e um toque sutil da borda vermelha de uma fivela de cinto de segurança é visível perto da parte inferior direita contra o carpete preto. A cena melancólica e sofisticada é iluminada por uma iluminação zenital dura e dramática que emana de duas luzes de leitura de teto douradas e quentes, projetando sombras de alto contraste, pretas profundas e duramente definidas sob o queixo, sob o laptop e flanqueando o interior do carro. Brilhantes realces especulares são preservados em seu rosto bem iluminado, no colarinho branco nítido, no mostrador metálico do relógio e nas bordas superiores dos luxuosos bancos de couro, realçando uma rica paleta complementar de azul-marinho profundo, marrom-conhaque, preto marcante e branco quente. Esta fotografia editorial de estilo de vida luxuoso é capturada digitalmente com realismo extremamente nítido e uma perspectiva frontal, evocando a estética de uma câmera full-frame usando uma lente de 35mm em f/2.0 para uma profundidade de campo média. Fotografada com um ISO alto de 3200 para introduzir ruído digital autêntico, a imagem apresenta pós-processamento cinematográfico com pretos esmagados para profundidade de sombra densa, contraste de cores aprimorado entre a camisa marinho e o couro marrom, e um aumento de nitidez nos traços faciais, tudo meticulosamente enquadrado em uma proporção de 4:5.
```
...
### Retrato fotorrealista de uma mulher elegante em um blazer vermelho posando em uma galeria de arte.

Autor：[@laviniavelle](https://x.com/laviniavelle) · [Publicação original](https://x.com/laviniavelle/status/2099345837688271000)

Fotografia · Retrato / Selfie · Personagem · Publicado

**Resumo:** Retrato fotorrealista de uma mulher elegante em um blazer vermelho posando em uma galeria de arte.
...
```text
Um retrato fotorrealista de alta resolução de uma jovem elegante com cabelos castanhos presos em um rabo de cavalo alto e franja frontal suave, posando em uma galeria de arte moderna. Ela veste um blazer vermelho-escuro sob medida sobre uma blusa de cetim creme, olhando para a câmera com um sorriso sutil e confiante. Sua mão repousa delicadamente perto do pescoço. O fundo apresenta um corredor de galeria de luxo suavemente desfocado e intensamente iluminado, com pinturas abstratas na parede e iluminação de estúdio ambiente quente de alto padrão, profundidade de campo rasa, resolução 8k, capturada com lente de 85 mm, fotorrealista.
```
...
### Modelo de prompt para fotos de campanha de relógios e produtos de couro de luxo. Especifica uma composição de still life destacando iluminação imponente e detalhes artesanais.

Autor：[@AIGuideNote](https://x.com/AIGuideNote) · [Publicação original](https://x.com/AIGuideNote/status/2097623415939076175)

Pôster / Flyer · Fotografia · Produto · Publicado

**Resumo:** Modelo de prompt para fotos de campanha de relógios e produtos de couro de luxo. Especifica uma composição de still life destacando iluminação imponente e detalhes artesanais.
...
・Objeto: {products} posicionados sobre couro vintage profundo ou texturas refinadas em tons escuros. Detalhes que evocam o trabalho artesanal (como costuras e acabamento em metal escovado) são retratados de forma bela e rica em detalhes.
・Iluminação e cores: Paleta de cores baseada em tons profundos de marrom-escuro, preto e dourado latão. Luz lateral quente em tom âmbar, com sombras clássicas e marcantes.
・Posicionamento do texto (para GPT-image / Nano Banana Pro): Textos como {goldText} e {subtext} são posicionados sutilmente com tipografia dourada em fontes finas, em uma posição harmoniosa da tela.

【Restrições rigorosas de layout e saída (Obrigatório)】
・Produza o design final em si, preenchendo toda a tela. Fundos ou representações de cena dentro do design (paredes, espaços, sombras, etc.) podem seguir as instruções do corpo do texto.
・Proibições: Fotos do pôster final em uma moldura, fotos coladas em uma parede, fotos de maquetes (mockups) sobre uma mesa ou papel, distorções de perspectiva nas bordas do papel ou sombras projetadas.
...
### Retrato cinematográfico de uma jovem melancólica em um hanbok segurando uma máscara sorridente ao lado do rosto.
...
**Resumo:** Retrato cinematográfico de uma jovem melancólica em um hanbok segurando uma máscara sorridente ao lado do rosto.
...
```text
Retrato de beleza cinematográfico ultrarrealista de uma jovem deslumbrante, preservando a identidade facial exata e os traços reconhecíveis do rosto de referência. Ela veste um elegante hanbok coreano de inspiração tradicional em tons suaves de rosa-chá e marfim. Ela tem longos cabelos negros escuros penteados em um coque baixo sofisticado com delicados ornamentos de pérola e uma fita rosa suave.

Seu rosto é lindo, natural e fotorrealista, com uma expressão claramente triste e melancólica — olhos ligeiramente caídos, uma sutil tristeza emocional no olhar, músculos faciais relaxados e lábios naturalmente suaves. A tristeza deve parecer autêntica e contida, não exagerada ou chorosa.

Ela segura uma máscara cerimonial tradicional ao lado do rosto com uma das mãos. A máscara se assemelha muito à sua identidade facial, estrutura do rosto, penteado e características reconhecíveis, criando a impressão de que representa seu próprio rosto. No entanto, a máscara expressa uma emoção completamente oposta: uma expressão genuinamente feliz e alegre, com olhos brilhantes e vivazes, bochechas levantadas e rosadas, e um sorriso caloroso e natural com lábios vermelhos. O rosto da mulher deve permanecer triste, enquanto a máscara permanece claramente alegre.

Ela usa uma blusa marfim com ombros à mostra decorada com delicados bordados florais cor-de-rosa, sobreposta por um xale de seda translúcido em tom rosa-antigo com intrincados detalhes florais dourados. Iluminação de estúdio suave e quente, fundo rosa-pêssego sonhador, sombras cinematográficas, poros de pele realistas, fios de cabelo individuais finos, texturas detalhadas de seda e bordado, profundidade de campo rasa, lente de retrato de 85 mm, f/1.8, bokeh suave, elegante fotografia editorial de moda coreana, narrativa visual emocional, fotorrealista, altamente detalhada, textura de pele natural, gradação de cor cinematográfica, detalhamento em 8K, composição vertical 4:5.
```
...
### Cena cinematográfica cyberpunk de um detetive e uma mulher de casaco amarelo vistos através da janela de um carro em uma noite chuvosa.
...
**Resumo:** Cena cinematográfica cyberpunk de um detetive e uma mulher de casaco amarelo vistos através da janela de um carro em uma noite chuvosa.
...
```text
{
  ...
  "image_description": "Uma cena cyberpunk cinematográfica vista através da janela de um carro encharcada de chuva. Reflexos de neon dançam pelo vidro enquanto um belo detetive futurista senta-se no banco do motorista vestindo um casaco escuro e pesado. Uma mulher vestindo uma jaqueta amarela translúcida e brilhante olha para ele. Veículos voadores se deslocam por uma cidade futurista envolta em neblina ao fundo.",

  "characters": [
    {
      "role": "Detetive Futurista",
      "position": "Banco do Motorista",
      "appearance": "Belo, expressão séria, casaco escuro e pesado",
      "focus": "Foco Nítido"
    },
    {
      "role": "Mulher Misteriosa",
      "position": "Banco do Passageiro",
      "appearance": "Cabelo escuro, jaqueta amarela translúcida e brilhante",
      "expression": "Observando calmamente o detetive",
  ...
  "quality": {
    "style": "Superprodução de Hollywood",
...
### Um prompt em estilo pseudocódigo para uma grade 2x2 de dioramas de santuário de mármore em 3D dedicados a pensadores famosos.
...
**Resumo:** Um prompt em estilo pseudocódigo para uma grade 2x2 de dioramas de santuário de mármore em 3D dedicados a pensadores famosos.
...
```text
grade 2x2, 16:9, faça isso para 4 pensadores, autores, inventores famosos,: class Mind_As_Shrine_Diorama:
    def __init__(self, thinker="[NOME_DO_PENSADOR]"):
        self.canvas = "Vinheta escultural monumental 3D única e independente sobre um fundo de estúdio branco puro."
        self.material_palette = "Mármore Carrara branco polido, latão escovado, lentes de vidro e vistas cósmicas brilhantes."

    def construct_face_and_hair_arch(self):
        # O trocadilho visual central: o cabelo se torna o edifício
        hair_motif = infer_iconic_hair_or_silhouette(self.thinker)
        name_arch = f"Letras maciças de mármore dourado em 3D soletrando '{self.thinker.upper()}' integradas diretamente em um arco de nuvens espirais barroco e ornamentado que representa o(a) {hair_motif} exagerado(a)."
        face_core = f"Centro: Um rosto realista esculpido em mármore de {self.thinker} emergindo do chão de pedra, usando óculos circulares onde as lentes de vidro exibem sua principal fórmula/símbolo."
        return [name_arch, face_core]

    def construct_internal_brain_chambers(self):
        # AUTO-INFERÊNCIA DA IA: Divida o legado intelectual deles em duas câmaras distintas
        theory_left = infer_primary_breakthrough(self.thinker) # ex., Relatividade Especial, portas lógicas, seleção natural
        theory_right = infer_secondary_breakthrough(self.thinker) # ex., Relatividade Geral, estado quântico, óptica
        
        chamber_left = f"Câmara Superior Esquerda: Quadros-negros em miniatura com equações autênticas de {theory_left}, modelos mecânicos de experimentos mentais (ex., trens, relógios, engrenagens) e uma biblioteca de livros minúsculos."
        chamber_right = f"Câmara Superior Direita: Vista cósmica do espaço profundo mostrando {theory_right}, completa com instrumentos ópticos, modelos de átomos e um poço/funil gravitacional volumétrico."
        return [chamber_left, chamber_right]

    def construct_base(self):
        quote = infer_signature_quote(self.thinker)
        return f"Um pedestal de mármore circular e em degraus com rebites de latão, um manuscrito aberto com texto manuscrito e uma placa curva de latão gravada com: '{quote}'."
...
### Retrato de uma jovem mulher vestindo uma camisa cropped branca desabotoada contra um fundo de estúdio rosa.
...
**Resumo:** Retrato de uma jovem mulher vestindo uma camisa cropped branca desabotoada contra um fundo de estúdio rosa.
...
```text
{
  "prompt": "Retrato 4k HD de uma jovem mulher com cabelos longos escuros e ondulados, olhos cor de avelã e uma expressão neutra olhando diretamente para a câmera, vestindo uma camisa cropped branca de manga curta com gola e desabotoada, com decote profundo, posando em frente a um fundo de estúdio rosa suave.",
  "subject": {
    "gender": "Feminino",
    "hair": {
      "color": "Castanho escuro",
      "style": "Longo, dividido ao meio, ondas naturais soltas caindo sobre ambos os ombros"
    },
    "facial_features": {
      "eyes": "Avelã / castanho claro, olhando diretamente para a lente",
      "eyebrows": "Naturalmente definidas, escuras",
      "skin": "Tez clara, textura natural, sutis pontos de luz com efeito viçoso",
      "expression": "Neutra, relaxada, calma"
    },
    "attire": {
      "top": "Camisa cropped branca de manga curta com gola",
      "style": "Decote profundo, frente desabotoada"
    }
  },
  "setting": {
    "background": "Fundo infinito de estúdio rosa pastel sólido",
    "details": "Borda de equipamento de estúdio visível no canto superior direito"
  },
  "technical_details": {
    "shot_type": "Retrato em plano médio-curto",
    "framing": "Composição centralizada, da cintura para cima",
    "lighting": "Iluminação de estúdio suave e difusa, preenchimento suave",
    "camera_settings": {
      "resolution": "4K UHD",
      "lens_type": "Lente de retrato de 85 mm",
      "depth_of_field": "Profundidade de campo rasa, foco nítido no tema com suave transição de desfoque no fundo",
...
### Retrato de moda de uma mulher do sul da Ásia usando trajes tradicionais amarelo-mostarda sob a luz do sol no terraço de uma cidade.
...
**Resumo:** Retrato de moda de uma mulher do sul da Ásia usando trajes tradicionais amarelo-mostarda sob a luz do sol no terraço de uma cidade.
...
```text
Uma linda jovem mulher do sul da Ásia usando um elegante shalwar kameez tradicional amarelo-mostarda com intrincados bordados dourados e delicados detalhes em lantejoulas, acompanhado por uma dupatta translúcida combinando, drapeada naturalmente sobre os ombros. Cabelos castanho-escuros longos, lisos e sedosos com risca ao meio, mechas suaves emoldurando seu rosto. Ela toca suavemente o cabelo com uma mão e sorri calorosamente para a câmera, expressão natural e confiante, lábios rosados sutis, traços faciais suaves e refinados, olhos castanho-claros expressivos. Usando brincos tradicionais jhumka dourados e um delicado colar com pingente. Luz solar natural e quente caindo suavemente sobre seu rosto, textura de pele realista, realces suaves, profundidade de campo rasa, fundo desfocado de terraço/cidade, fotografia cinematográfica de estilo de vida, elegante editorial de moda paquistanesa, cores naturais, bordados de tecido altamente detalhados, fotorrealista, lente de retrato de 85 mm, bokeh suave, iluminação realista, composição vertical, 9:16.
```
...
### Paisagem noturna de longa exposição com lanternas de papel flutuando em um rio escuro.
...
**Resumo:** Paisagem noturna de longa exposição com lanternas de papel flutuando em um rio escuro.
...
```text
#obra-prima #foto realista #paisagem #longa exposição #lanternas de papel flutuantes #correnteza escura #reflexos quentes #silêncio da meia-noite
```
